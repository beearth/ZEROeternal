...
export function UserProfilePage({ user: currentUser }: UserProfilePageProps) {
    ...
    return <div className="flex-1 flex flex-col h-full bg-[#1e1f20] overflow-y-auto">
        {/* Header */}
        <div className="sticky top-0 z-10 bg-[#1e1f20]/95 backdrop-blur-md border-b border-[#2a2b2c]">
            <div className="max-w-3xl mx-auto px-4 py-3 flex items-center gap-3">
                <button
                    onClick={() => navigate(-1)}
                    className="p-2 hover:bg-[#2a2b2c] rounded-full transition-colors"
                >
        ...
        <div className="p-4 max-w-3xl mx-auto w-full space-y-6">
            {/* Profile Card */}
            <div className="bg-[#2a2b2c] rounded-[32px] overflow-hidden shadow-sm border border-[#3a3b3c] p-6 pt-0 relative">
                {/* Banner Area */}
                <div className="h-32 bg-[#3a3b3c] w-full rounded-2xl border-2 border-[#4a4b4c] mt-6 relative"></div>

                <div className="px-2 relative">
                    <div className="flex justify-between items-start min-h-[80px]">
                        {/* Avatar - Overlapping Banner */}
                        <div className="-mt-20 ml-4 relative z-10 group/avatar">
                            <div className="rounded-full p-1.5 bg-[#3a3b3c] border-[3px] border-[#4a4b4c] w-36 h-36 flex items-center justify-center overflow-hidden shadow-sm relative">
                            ...
                            <div className="flex gap-3">
                                {!isCurrentUser && (
                                    <Button
                                        ...
                                        className={`h-11 px-8 font-black text-lg border-[3px] shadow-sm transition-all rounded-xl ${isFollowing
                                            ? 'bg-[#2a2b2c] text-zinc-400 hover:bg-[#3a3b3c] border-[#3a3b3c]'
                                ...
                                {!isCurrentUser && (
                                    <Button
                                        ...
                                        className="w-11 h-11 p-0 rounded-full border-[3px] border-[#3a3b3c] bg-[#2a2b2c] hover:bg-[#3a3b3c] text-zinc-400 shadow-sm flex items-center justify-center"
                                    >
                ...
                {isEditingProfile ? (
                    <div className="flex items-center gap-2">
                        <input
                            ...
                            className="text-2xl font-black text-white border-b-2 border-[#3a3b3c] focus:border-blue-500 focus:outline-none bg-transparent w-48"
                        />
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        {isCurrentUser && (
                            <button
                                ...
                                className="p-1.5 text-zinc-500 hover:text-blue-400 hover:bg-[#2a2b2c] rounded-full transition-colors"
                            >
            ...
            {/* Languages */}
            <div className="flex flex-wrap gap-10 mt-8 ml-4 text-sm font-black text-zinc-300">
                <div className="flex items-center gap-2">
            ...
            {/* Bio Box */}
            <div className="bg-[#2a2b2c] rounded-xl p-4 border-2 border-[#3a3b3c] shadow-sm relative group">
                {isEditingBio ? (
                    <div className="space-y-3">
                        <textarea
                            value={tempBio}
                            onChange={(e) => setTempBio(e.target.value)}
                            className="w-full bg-[#2a2b2c] rounded-lg p-3 text-sm text-white border border-[#3a3b3c] focus:outline-none focus:ring-2 focus:ring-blue-500 min-h-[100px] resize-none placeholder:text-zinc-500"
                        ...
                        <div className="flex justify-end gap-2">
                            <button
                                ...
                                className="px-3 py-1.5 text-xs font-bold bg-[#2a2b2c] text-zinc-400 rounded-lg border border-[#3a3b3c] hover:bg-[#3a3b3c]"
                            >
                                취소
                            </button>
                            <button
                                onClick={handleSaveBio}
                                className="px-3 py-1.5 text-xs font-bold bg-blue-500 text-white rounded-lg hover:bg-blue-600"
                            >
                                저장
                            </button>
                        </div>
                    ...
                    <>
                        <p className={`text-sm leading-relaxed font-medium whitespace-pre-wrap ${!postUser.bio ? 'text-zinc-500' : 'text-white'}`}>
                        ...
                        {isCurrentUser && (
                            <button
                                ...
                                className="absolute top-2 right-2 p-1.5 bg-[#3a3b3c] hover:bg-[#4a4b4c] rounded-full text-blue-400 opacity-0 group-hover:opacity-100 transition-all"
                            >
            ...
            {/* Divider */}
            <div className="border-b border-[#2a2b2c]"></div>
