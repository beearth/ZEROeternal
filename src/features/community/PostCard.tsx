import { Heart, MessageSquareMore, MessageSquareQuote, Pencil, Trash2 } from 'lucide-react';
...
export function PostCard({ user, image, content, likes, timeAgo, onChat, isOwner = false, onEdit, onDelete, onLike, isLiked = false, onClickProfile }: PostCardProps) {
    ...
    return (
        // <div className="shadow-sm border border-slate-100 p-6">
        ...
        //                 <span className="text-sm font-medium text-slate-500 group-hover:text-blue-500 transition-colors">댓글</span>
        //             </button>
        //         </div>
